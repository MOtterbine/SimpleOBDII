...
public class Constants
{
    ...
    //public const string MSG_CONTACTING_ECU = "Contacting Vehicle...";
    public const string MSG_CONTACTING_MODULE = "Contacting Module...";
    public const string MSG_UPLOADING = "Uploading...";
    public const string MSG_UPLOAD_FINISHED = "Upload Finished";
    public const string MSG_READING_FILE = "Reading File...";
   ...
   // public const string PREFS_WIFI_TYPE_DESCRIPTOR = "WiFi/Network";
    ...
    public const string PREFS_KEY_DEVICE_COMM_TYPE = "communication_type";
  ...
  //  public const string COMMUNICATION_DEVICE_NOT_SETUP = "*** Device Not Set ***";
    ...
    public const int DEFAULT_COMM_NO_RESPONSE_TIMEOUT = 1300;
    public const int DEFAULT_COMM_NO_RESPONSE_RETRY_COUNT = 4;
    public const int DEFAULT_COMM_CONNECT_RETRY_COUNT = 4;
