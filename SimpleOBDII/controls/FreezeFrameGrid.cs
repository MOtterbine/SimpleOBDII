...
namespace OS.OBDII.Controls
{
    ...
    public partial class FreezeFrameGrid : Grid, IDisposable
    {
        private ResourceDictionary customStyles = null;

        public FreezeFrameGrid()
        {
            InitializeComponent();
        ...
        public static readonly BindableProperty EmptyGridStringProperty =
            BindableProperty.Create("EmptyGridString", typeof(string), typeof(FreezeFrameGrid), Constants.STRING_NO_DATA);
        ...
        public static readonly BindableProperty MonitorTitleProperty =
            BindableProperty.Create("MonitorTitle", typeof(string), typeof(FreezeFrameGrid), "Tests");
        ...
        public static readonly BindableProperty ItemsSourceProperty =
            BindableProperty.Create("ItemsSource", typeof(ObservableCollection<IPid>), typeof(FreezeFrameGrid), new ObservableCollection<IPid>());
        ...
        public static readonly BindableProperty SourceIsEmptyProperty =
            BindableProperty.Create("SourceIsEmpty", typeof(bool), typeof(FreezeFrameGrid), true);
        ...
        public static readonly BindableProperty ShowHeaderProperty =
            BindableProperty.Create("ShowHeader", typeof(bool), typeof(FreezeFrameGrid), true);
