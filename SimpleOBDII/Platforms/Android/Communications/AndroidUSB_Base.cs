...
namespace OS.OBDII.PartialClasses
{
    ...
    public class AndroidUSB_Base 
    {
        ...
        private async void beginListen()
        {
            ...
            if (this.IsConnected = TryDeviceConnect(AppShellModel.Instance.CommunicationChannel))
            {
            ...
            {
                // more specific errors are fired from TryDeviceConnect()
          //      FireErrorEvent($"Unable to access device: {AppShellViewModel.Instance.CommunicationChannel}");
            }
